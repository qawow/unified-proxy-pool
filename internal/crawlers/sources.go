...
func DefaultSources() []Crawler {
	...
	list := []Crawler{
		...
		HTMLTable("spys-one", []string{"https://spys.one/en/anonymous-proxy-list/"}, 0, 1, true, false),
		RegexSource("spys-socks", []string{"https://spys.one/en/socks-proxy-list/"}, "socks5", true, false),
